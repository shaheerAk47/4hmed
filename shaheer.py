...
\033[1;91m--> GITHUB :- https://github.com/shaheerAk47/4hmed
...
def login():
	...
	print "1.\x1b[1;95mLogin  Facebook  "
        time.sleep(0.05)
        print "2.\x1b[1;95mHow To Get Acess Token "
        time.sleep(0.05)
...
def pilih_login():
	...
	if peak =="":
	 ...
	 print "\x1b[1;91mYou CAN GET ACESSS TOKEN FROM THE APP •GetAcessToken•       
	        login()
	elif peak =="3":
	        tokenz()
	elif peak =="0":
